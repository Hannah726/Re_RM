        ...
        self.tables = [
            {
                ...
                "desc_key": ["label"],
                 # Original: dtype in official documents
                "original_numeric": ["valuenum", "ref_range_lower", "ref_range_upper"],
                "original_categorical": ["itemid", "value", "valueuom", "flag", "priority", "comments"],
                # Numeric: determined by actual data (e.g., if 99% numeric and 1% categorical, treat as numeric)
                "numeric": ["valuenum", "ref_range_lower", "ref_range_upper"],
                # Categorical: determined by actual data
                "categorical": ["itemid", "value", "valueuom", "flag", "priority", "comments"],
                # Item: column name for item identification
                'item': "itemid",
            },
            {
            ...
            },
            {
                ...
                "categorical": ["itemid", "amountuom", "rateuom", "ordercategoryname", "secondaryordercategoryname", "ordercomponenttypedescription", "ordercategorydescription", "totalamountuom", "isopenbag"],
                'item': "itemid",
                'item_unrelated': ["patientweight"],
            },
        ]
